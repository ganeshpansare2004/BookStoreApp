    ...
    <>
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10">
        ...
        <div className="space-y-12">
          ...
          <p className="text-x1 ">Reading books opens the door to knowledge, imagination, and new perspectives.
Just a few pages a day can shape the way we think and understand the world.</p>
